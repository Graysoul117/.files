...
alias s2b='xrandr --output HDMI-0 --brightness'
alias s1b='xrandr --output DP-1 --brightness'
alias sb1='xrandr --output DP-1 --brightness'
alias s3b='xrandr --output DP-3 --brightness'
alias sb3='xrandr --output DP-3 --brightness'
alias sba1='xrandr --output HDMI-0 --brightness 1  --output DP-3 --brightness 1'
alias sba2='xrandr --output HDMI-0 --brightness 2  --output DP-3 --brightness 2'
alias sba3='xrandr --output HDMI-0 --brightness 3  --output DP-3 --brightness 3'


#Screens Off
alias sso='xset dpms force off'
